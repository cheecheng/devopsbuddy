...
public class ForgotMyPasswordController {
    ...
    public static final String EMAIL_MESSAGE_SUBJECT_PROPERTY_NAME = "forgotmypassword.email.subject";
    ...
    @Autowired
    public ForgotMyPasswordController(PasswordResetTokenService passwordResetTokenService, EmailService emailService, I18NService i18NService, UserService userService) {
    ...
    public String forgotPasswordPost(HttpServletRequest request,
        ...
        if (null == passwordResetToken) {
            ...
            String emailSubject = i18NService.getMessage(EMAIL_MESSAGE_SUBJECT_PROPERTY_NAME, request.getLocale());
    ...
    /**
     *
     * @param id    Come from email URL
     * @param token Come from email URL
     * @param locale
     * @param model
     * @return
     */
    ...
    public String changeUserPasswordGet(@RequestParam("id") long id,
        ...
        // is authenticated. Only authenticated user can perform the action.
    ...
    public String changeUserPasswordPost(@RequestParam("principal_id") long userId, // come from hidden field in the form
        ...
        if (null == authentication) {
            ...
            model.addAttribute(PASSWORD_RESET_ATTRIBUTE_NAME, "false");
            model.addAttribute(MESSAGE_ATTRIBUTE_NAME, "You are not authorized to preform this request.");
            return CHANGE_PASSWORD_VIEW_NAME;
        }
